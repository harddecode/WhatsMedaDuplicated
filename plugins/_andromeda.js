...
const Lang = Language.getString('_andromeda');

if (Config.WORKTYPE == 'private') {

    Meda.addCommand({pattern: 'andromeda ?(.*)', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    ...
    Meda.addCommand({pattern: 'andromeda ?(.*)', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
